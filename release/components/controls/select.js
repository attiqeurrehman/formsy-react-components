...
var SelectControl = function (_Component) {
    ...
    function SelectControl() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SelectControl.__proto__ || Object.getPrototypeOf(SelectControl)).call.apply(_ref, [this].concat(args))), _this), _this.renderOption = function (item, key) {
