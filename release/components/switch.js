...
var Switch = function (_Component) {
    ...
    function Switch() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Switch.__proto__ || Object.getPrototypeOf(Switch)).call.apply(_ref, [this].concat(args))), _this), _this.handleChange = function (event) {
...
Switch.propTypes = _extends({}, _controlCommon2.default.propTypes, _componentCommon2.default.propTypes, {
    value: _propTypes2.default.bool,
    valueLabel: _propTypes2.default.string
});

Switch.defaultProps = _extends({}, _componentCommon2.default.defaultProps, {
    value: false,
    valueLabel: ''
});
